import { Box, Em, Heading, Image, Text, Link, Container } from '@chakra-ui/react';
      ...
      <Box display={'flex'} flexDir={'column'} gap={'6'}>
        ...
        <Box>
          ...
          <Text textStyle={'sm'}>
            ...
            own dotfile configs that you can check out on my{' '}
            <Link href={'https://github.com/dolinekvit/dotfiles'}>Github</Link>. I welcome challenges and try to improve
